"""
Django settings for djgsckpuptst project.
...
SECRET_KEY = get_env_variable('DJ_SO_TE_SECRET_KEY')
...
ROOT_URLCONF = 'djgsckpuptst.urls'
...
WSGI_APPLICATION = 'djgsckpuptst.wsgi.application'
